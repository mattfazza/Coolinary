...
router.get('/', passport.authenticate('jwt', { session: false }), (req, res) => {
    ...
    if (req.body.twitter) profileFields.social.twiiter = req.body.twiiter;
    if (req.body.linnkedin) profileFields.social.linkedin = req.body.linkedin;
